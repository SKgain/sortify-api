# --- SCRIPT 2: EXPERIMENTAL MODEL WITH EfficientNetB0 ---
# Swaps MobileNetV2 for EfficientNetB0 for potentially higher accuracy.
...
IMAGE_SIZE = (224, 224)
BATCH_SIZE = 32 # EfficientNet is heavier, a smaller batch size is safer
NUM_CLASSES = 4 # Assuming 4 classes for waste
BEST_MODEL_PATH = 'waste_classifier_efficientnet_b0_final.keras' # New model name
...
# EfficientNetB0 has 237 layers. Let's unfreeze from layer 190 onwards.
